...
본 프로젝트의 최근 10개년 분석 범위는 **규제시작일이 2015-01-01 이후인 반덤핑 규제 건**으로 정의한다.  
원천 데이터의 `국가명`은 복수 국가를 하나의 셀에 포함할 수 있으므로, 규제 건수는 원천 행 기준과 국가 분리 이벤트 기준을 구분해 해석한다.

| 기준 | 원천 행 기준 | 국가 분리 이벤트 기준 | 유니크 국가 수 | 유니크 품목 수 |
|------|-------------:|---------------------:|---------------:|---------------:|
| 2015년 이후 시작 전체 | 62 | 104 | 20 | 49 |
| 2025-12-31 추출 기준 진행 중 | 27 | 44 | 15 | 25 |
| 2026-05-20 현재 진행 중 | 25 | 42 | 15 | 23 |

연도별 신규 규제 시작 건수(원천 행 기준)는 다음과 같다.
...
2015년 이후 시작 건의 유니크 대상 국가는 20개국이다.

`대만`, `말레이시아`, `미국`, `베트남`, `사우디아라비아`, `스페인`, `싱가포르`, `아랍에미레이트`, `우크라이나`, `이집트`, `이탈리아`, `인니`, `인도`, `인도네시아`, `일본`, `중국`, `태국`, `프랑스`, `핀란드`, `호주`

2026-05-20 현재 진행 중인 2015년 이후 시작 건의 유니크 대상 국가는 15개국이다.

`대만`, `말레이시아`, `미국`, `베트남`, `아랍에미레이트`, `우크라이나`, `이집트`, `인니`, `인도`, `일본`, `중국`, `태국`, `프랑스`, `핀란드`, `호주`

2025-12-31 추출 기준으로 진행 중이었으나 2026-05-20 현재 종료된 건은 2건이다.

| 국가명 | 품목 | 부과시작일 | 부과종료일 |
|--------|------|------------|------------|
| 중국 | H형강 | 2021-03-30 | 2026-03-29 |
| 중국 | 인쇄제판용 평면모양 사진 플레이트(옵셋 인쇄판) | 2021-05-03 | 2026-05-02 |
